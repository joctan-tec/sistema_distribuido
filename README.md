...
## Índice
1. [Explicación de la arquitectura](#explicación-de-la-arquitectura) 
2. [Mecanismos de comunicación](#mecanismos-de-comunicación)
3. [Sincronización](#sincronización)
4. [Gestión de fallos](#gestión-de-fallos)
